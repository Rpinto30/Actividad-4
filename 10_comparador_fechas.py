...
#CALCULA LOS DÍAS QUE FALTAN PARA ACABAR EL MES. EJ: EL 20/07/2025 FALTAN 11 DÍAS
...
if len(dates) > 0:
    ...
    print(f"Los días que han pasado entre ambas fechas son: {days_between+1}")
